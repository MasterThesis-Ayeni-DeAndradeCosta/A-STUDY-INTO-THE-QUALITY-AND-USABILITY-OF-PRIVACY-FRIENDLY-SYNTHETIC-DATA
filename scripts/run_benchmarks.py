...
def run_benchmarks():
    ...
    if enable_synthetic:
        synthetic_datasets, metadata = generate_synthetic_datasets(encoded_data, dataset_name, config)
        print("\nSynthetic Data Generation Completed.")
        # # Evaluate each synthetic dataset separately 
        ...
        quality_reports = {}  # Store quality metrics
        # Evaluate each synthetic dataset separately
        for synth_name, synthetic_data in synthetic_datasets.items():
            print(f"\nEvaluating synthetic dataset generated by {synth_name}...")
            quality_report = evaluate_synthetic_data(encoded_data, synthetic_data, metadata, target_column, dataset_name)
        ...
        # Append data distribution comparison to the same report
        compare_data_distributions(output_dir, encoded_data, synthetic_datasets, target_column)
    else:
    ...
    encoded_data, synthetic_datasets, target_column, test_size, enable_synthetic, config
)
